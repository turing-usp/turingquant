...
def test_metrics():
"""
Essa função define uma série aleatória de 50 elementos de retornos de um ativo fictício e de um índice de mercado e. a partir deles, fornece o beta e o sharpe ratio do ativo fictício, com o objetivo de testar as funções beta e sharpe_ratio. 
"""
